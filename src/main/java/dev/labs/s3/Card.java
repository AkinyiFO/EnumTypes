// Source: https://docs.oracle.com/javase/tutorial/java/javaOO/examples/Card.java
...
public class Card {
    ...
    public static void main(String[] args) {
        ...
        // If on the command line, you must run program with -ea flag (java -ea ..) to use assert statements.
        // I.e. java -ea YourProgram.class
